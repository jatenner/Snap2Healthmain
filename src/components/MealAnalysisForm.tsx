    ...
    return (
      <div className="max-w-4xl mx-auto p-4">
        <div className="relative w-full h-64 mb-6 rounded-lg overflow-hidden">
          ...
          {processedImageUrl && (
            <Image src={processedImageUrl} alt="Uploaded meal" fill className="object-cover" />
          )}
        </div>
        
        <h2 className="text-2xl font-bold mb-4">{mealName || 'Your Meal'}</h2>
        
        {/* Use SimpleFoodAnalysis for all analysis */}
        <SimpleFoodAnalysis 
          imageUrl={processedImageUrl} 
          goal={userGoal || "General Wellness"}
        />
