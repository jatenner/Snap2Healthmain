...
export async function GET(
  ...
  try {
    ...
    const formattedData = {
      ...
      mealDescription: data.meal_description || (analysisData as any)?.mealDescription || 'A delicious and nutritious meal',
      ...
      healthScore: data.health_score || (analysisData as any)?.health_score || (analysisData as any)?.healthScore,
